...
class Build extends Action
{
    ...
    public function createPackage($type, $config, $scopeConfigInterface) {
        ...
        if (
            $scopeConfigInterface->getValue('simipwa/pwa_package/use_uploaded_package_file', \Magento\Store\Model\ScopeInterface::SCOPE_STORE) &&
        ...
        if ($type == Data::BUILD_TYPE_SANDBOX) {
            if (
                $scopeConfigInterface->getValue('simipwa/pwa_package/use_uploaded_package_file_sandbox', \Magento\Store\Model\ScopeInterface::SCOPE_STORE) &&
